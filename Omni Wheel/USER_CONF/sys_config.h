...
#define INFANTRY_3 3
#define INFANTRY_4 4
#define INFANTRY_5 5   //旧全向
#define INFANTRY_24 24 //新全向
#define TEST_SHOOT 6

#define INFANTRY_NUM INFANTRY_24 // 可以修改步兵号数
...
/* 遥控模式 云台速度控制 */
/* pitch 轴 速度 */
#define GIMBAL_RC_MOVE_RATIO_PIT  -1.4f // 小全向的pit电机与普通麦轮步兵装配不同
/* yaw 轴 速度 */
#define GIMBAL_RC_MOVE_RATIO_YAW 1.6f

/* 键盘模式 云台速度控制 */
/* pitch 轴 速度 */
#define GIMBAL_PC_MOVE_RATIO_PIT -0.6f // 小全向的pit电机与普通麦轮步兵装配不同
/* yaw 轴 速度 */
